  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        setErrors({ submit: "Error during sign up. Please try again." });
      }
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-1">
                    ...
                    />
                    {errors.fname && (
                      <p className="text-xs text-error-500 mt-1">{errors.fname}</p>
                    )}
                  </div>
                  {/* <!-- Last Name --> */}
                  <div className="sm:col-span-1">
                    ...
                    />
                    {errors.lname && (
                      <p className="text-xs text-error-500 mt-1">{errors.lname}</p>
                    )}
                  </div>
                </div>
                {/* <!-- Email --> */}
                ...
                <div>
                  ...
                  <select
                    ...
                    value={formData.role}
                    onChange={handleInputChange}
                    className="w-full px-4 py-2 border rounded-lg border-gray-200 bg-white text-gray-700 dark:border-gray-800 dark:bg-gray-800 dark:text-white/90"
                  >
                ...
                <div>
                  ...
                  {errors.password && (
                    <p className="text-xs text-error-500 mt-1">{errors.password}</p>
                  )}
                </div>
                {/* <!-- Button --> */}
                <div>
